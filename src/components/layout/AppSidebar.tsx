...
function NavSections({
  ...
  sections: typeof mainNavSections;
  pathname: string;
  onChatOpen: () => void;
}) {
  return (
...
export function AppSidebar() {
  ...
  const sections = isAdmin
    ? [...mainNavSections, adminNavSection]
    : mainNavSections;

  return (
    <Sidebar className="border-r border-sidebar-border bg-sidebar">
      <SidebarHeader className="border-b border-sidebar-border/70 px-4 py-5">
        <Link href="/dashboard" className="outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-lg">
          <Logo />
        </Link>
      </SidebarHeader>
