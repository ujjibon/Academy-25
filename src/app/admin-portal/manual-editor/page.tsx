...
function ManualEditorContent() {
    ...
    useEffect(() => {
        ...
        if (courseParam) {
            handleCourseSelect(courseParam);
        }
    ...
    const handleUploadCourse = async () => {
        ...
        setIsUploading(true);
        try {
            const response = await adminFetch('/api/course', {
                method: 'POST',
    ...
    return (
        <div className="space-y-4">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Manual Course Editor</h1>
                <p className="text-muted-foreground mt-1">
                    Edit course JSON and save directly to the server.
                </p>
            </div>
            <Card>
                <CardHeader>
