        ...
        <Card className="brand-card">
          ...
          <CardContent>
            <div className="space-y-2">
              <Label htmlFor="topic">What should we teach you?</Label>
              <TopicInput
                topic={topic}
                setTopic={setTopic}
                isLoading={isLoading}
        ...
        {generated && (
          <Card className="brand-card">
            ...
            <CardContent className="space-y-4">
              ...
              <Section title={`${generated.lessons.length} lessons in ${groupLessonsIntoModules(generated.lessons).length} modules`}>
